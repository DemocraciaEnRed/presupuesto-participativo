...
ENV LOCALE=es \
  ...
  NOTIFICATIONS_MAILER_EMAIL=speak@democracyos.org \
  NOTIFICATIONS_MAILER_NAME='Presupuesto Participativo' \
  ORGANIZATION_EMAIL=speak@democracyos.org \
  ORGANIZATION_NAME='Presupuesto Participativo' \
  SOCIALSHARE_SITE_NAME='Presupuesto Participativo' \
  SOCIALSHARE_SITE_DESCRIPTION='Plataforma de participación ciudadana.' \
  SOCIALSHARE_IMAGE=https://cldup.com/xjWy914AyG.jpg \
  SOCIALSHARE_DOMAIN=speak@democracyos.org \
